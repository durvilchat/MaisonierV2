...
public class Presentation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCoordinator = (CoordinatorLayout) findViewById(R.id.activity_presentation);
        ...
        mFinishBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Utils.saveSharedSetting(Presentation.this, Login.PREF_USER_FIRST_TIME, "false");
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        int[] bgs = new int[]{R.drawable.contrat, R.drawable.usuario, R.drawable.bailleur};
